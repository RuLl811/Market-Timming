...
Rm2 = model.t_test( 'Rm2 = 0' )

print( rm )
print( Rm2 )
if rm.pvalue < 0.05:
    print( "El coeficiente de Rm es significativo al 5%." )
else:
    print( "El coeficiente de Rm no es significativo al 5%." )
if Rm2.pvalue < 0.05:
    print( "El coeficiente de Rm2 es significativo al 5%." )
else:
    print( "El coeficiente de Rm2 no es significativo al 5%." )
...
def calculate_rolling_betas(X, y, window_size):
    ...
    for start in range(len(y) - window_size + 1):
        ...
        rolling_betas['Beta2'].append(model.params['Rm2'])
...
plt.plot(rolling_betas['Beta2'], label='Rolling Beta 2 (Rm2)')
plt.xlabel('Fecha')
plt.ylabel('Beta')
